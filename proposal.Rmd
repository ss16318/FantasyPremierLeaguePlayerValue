...
1) Raising the issue in the comments section of the website
2) Contacting their Twitter page to notify them of the issue

Further, if the source of the error came from Opta, we could raise this issue through
their "Get In Touch" page. Hence, we are able to contact our sources of data should 
there be doubt about accuracy.
