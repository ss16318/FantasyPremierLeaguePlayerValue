...
to select benched or injured players. Given relevant soccer players do get hurt for brief periods 
during the season, we found that filtering on an average of 45 minutes allowed us to remove irrelevant players,
