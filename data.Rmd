...
Fantasy Overlord, an database maintained by Fantasy Football enthusiasts
...
For use, when the data is imported again, three columns are appended AssistPoints, GoalScoredPoints, and CleanSheetsPoints. For every row, the numerical value for each of the following three columns are calculated as follows: for forwards, assists are 3 points, goals are 4 point, and cleansheets are 0 points; for midfielders, assists are 3 points, goals are 5 point, and cleansheets are 1 points; for defenders, assists are 3 points, goals are 5 point, and cleansheets are 4 points.
