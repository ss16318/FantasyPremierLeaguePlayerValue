...
fantasy player 'costs' and fantasy player point totals, which are not 
on the EPL website. Additionally, the data set we're using also represents all 
information available to fantasy players. 
...
full 2017 and 2021 seasons. Each Premiere League season is composed of 38 match 
...
by year, for which each player is one observation, and variables will have
key metrics for each week. From there, we will aggregate player statistics 
based on the given analysis question at hand. Since the data fields are consistent 
across CSV files, appending the data and labeling the match week & year of the
appended data should be achievable.
...
Lastly, player point metrics include Points Last Round, Total Points, and Average Points Per Week.
